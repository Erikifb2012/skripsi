...
$destinationPath = 'dokumen'; // upload path

// Disini proses mendapatkan judul dan memindahkan letak gambar ke folder image
$file       = $request->file('doc');
$realname   = $file->getClientOriginalName();
// $fileName = rand(11111,99999).'.'.$realname; // renameing image
$request->file('doc')->move($destinationPath,$realname);

$tambah->name_doc = $realname;
$tambah->save();
...
foreach ($pages as $page) { 
  $path.$page->getText();
  return view('hasil',compact('path'));
...
// return view('hasil', compact('path','pages'));
}
}